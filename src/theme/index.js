export default {
	...
	"font": {
		...
		"liadMinobr": "14px/100% Montserrat, sans-serif",
		"h3Minobr": "bold 16px/120% --fontFamily-googleMontserrat",
		"h2Minobr": "bold 36px/150% --fontFamily-googleMontserrat",
		"minobrbold": "bold 24px/120% --fontFamily-googleMontserrat",
		"h3Normal": "16px --fontFamily-googleMontserrat"
	},
	"boxShadow": {
	...
	"background": {
		"primaryGradient": "linear-gradient(180deg,--color-minobrBlue 0%,transparent 100%) 0 0 no-repeat",
		"secondaryGradient": "linear-gradient(180deg,--color-darkL2 0%,transparent 100%) 0 0 no-repeat"
	},
	"transform": {
